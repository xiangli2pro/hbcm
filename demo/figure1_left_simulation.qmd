---
title: "Figure 1 (left plot) Simulation Code"
format: pdf
editor: visual
---
...
Figure 1 (left plot) in the manuscript experiments $\sigma$ taking different values in `{2,3,4,5,6,7,8,9,10}` . For the demo purpose, we set $\sigma=6$.
